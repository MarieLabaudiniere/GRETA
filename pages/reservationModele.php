...
<!-- Pop-up : div qui s'affiche lorsque l'on clique sur l'icône planning -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="index.php?page=reservation" method="post" id="creation-resa">
                    ...
                    <div class="mt-3">
                        <button name="creationResa" type="submit" class="btn">Réserver</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="container mt-3">
    <form action="index.php?page=reservation" method="post">
        <div class="row">
            ...
            <div class="col">
                <input type="date" name="date_debut_resa" class="form-control" placeholder="" value="<?php echo @$_POST['date_debut_resa'] ?>" required>
            </div>
            <div class="col">
                <input type="date" name="date_fin_resa" class="form-control" placeholder="" value="<?php echo @$_POST['date_fin_resa'] ?>" required>
            </div>
            <div class="row">
                <div class="col">
